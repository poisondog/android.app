 ...
 */
/*
public class PictureFragment extends DebugFragment {
	private RecyclerView mPictureWall;
	private SwipeRefreshLayout mSwipeRefreshLayout;

	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View v = inflater.inflate(R.layout.picture_wall, container, false);
		mPictureWall = (RecyclerView)v.findViewById(R.id.list);
		mPictureWall.setLayoutManager(new LinearLayoutManager(getActivity()));
...
//		mPictureWall.setOnScrollListener(new RefreshOnTop(mSwipeRefreshLayout));
		return v;
	}
	...
	public RecyclerView getPictureWall() {
		return mPictureWall;
	}
}*/
