...
public abstract class AsyncTask<Params, Progress, Result> implements Cancellable {
			...
			@Override
				protected void done() {
					try {
						...
						android.util.Log.w(getClass().getSimpleName(), e);
